...
var HomePage = /** @class */ (function () {
    function HomePage(router, navCtrl, service, alert) {
        this.router = router;
        this.navCtrl = navCtrl;
        this.service = service;
        this.alert = alert;
        this.lists = list_1.lists;
        this.show();
    }
    ...
    HomePage.prototype.add = function () {
        this.navCtrl.goForward('/form');
    };
    HomePage.prototype.deleteList = function (i) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    ...
                                    handler: function () { return __awaiter(_this, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0: return [4 /*yield*/, this.service.delete(i)];
                                                case 1:
                                                    _a.sent();
                                                    return [2 /*return*/];
                                            }
                    ...
                    case 1:
                        alertdelete = _a.sent();
                        return [4 /*yield*/, alertdelete.present()];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
